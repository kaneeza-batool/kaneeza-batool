...
My strengths are turning design thinking into working code, learning fast through real projects, and staying consistent.
...
```js
const profile = {
  role: "Full-Stack Developer (MERN) + Applied AI",
  ...
  stack: {
    ...
    backend:  ["Node.js", "Express.js", "MongoDB", "SQLite", "REST", "WebSockets"],
    ai:       ["CrewAI", "FastAPI", "Groq", "OpenAI", "Gemini", "RAG"],
    languages:["JavaScript", "TypeScript", "Python", "Java", "C++"]
  },
  currentFocus: "PakLawAI (RAG legal assistant) and DSA in Java",
  dailyHabit: "LeetCode",
  lookingFor: "Remote full-stack or AI engineering role",
...
### auraCheck: Live Voice Mock-Interview Platform
...
A five-surface institute management platform: public website, student portal, super admin portal, campus-scoped sub admin portal, and trainer portal. Per-module role-based access control, QR-based attendance with generated student ID cards, a campus map, a job portal with applicant matching, automated absence and payment alerts, and an AI assistant on the public site.
...
Built for the USAII Global AI Hackathon 2026. An AI companion for elderly Pakistanis that reads screens, detects scams, and explains government forms in plain language, using a multi-agent architecture with seven specialised agents and on-device PII redaction.
...
### JobSkillShare Website Redesign

`HTML` `CSS` `JavaScript` `UX Audit` `Responsive Design`
...
![Remote Internships](https://img.shields.io/badge/Open_to-REMOTE_INTERNSHIPS-2EA44F?style=for-the-badge)
![Freelance](https://img.shields.io/badge/Open_to-FREELANCE_PROJECTS-0A66C2?style=for-the-badge)
![Open Source](https://img.shields.io/badge/Open_to-OPEN_SOURCE-FF6B35?style=for-the-badge)
![Hackathons](https://img.shields.io/badge/Open_to-HACKATHONS-8E44AD?style=for-the-badge)

If you're hiring, building something interesting, or want to collaborate, reach out. I respond fast and deliver on time.

[![LinkedIn](https://img.shields.io/badge/LinkedIn-MESSAGE_ME-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/kaneeza-batool)
[![Email](https://img.shields.io/badge/Email-kaneezabatoolmemon@gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kaneezabatoolmemon@gmail.com)
